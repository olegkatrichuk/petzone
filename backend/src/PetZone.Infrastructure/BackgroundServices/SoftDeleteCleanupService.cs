...
namespace PetZone.Infrastructure.BackgroundServices;
    ...
    IOptions<SoftDeleteOptions> options) : BackgroundService
{
    ...
    private async Task CleanupAsync(CancellationToken cancellationToken)
    {
        ...
        // Используем scope потому что DbContext — Scoped сервис
        // а BackgroundService — Singleton
        ...
        try
        {
            // Находим всех волонтёров помеченных как удалённые
            // у которых DeletedAt старше retention period
